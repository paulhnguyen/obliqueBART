...
# Details: hepatitis dataset (https://archive.ics.uci.edu/dataset/46/hepatitis)
# Dependencies: 
...
# load data
data = read.csv(paste0(data_dir, "hepatitis.data"), header = FALSE, sep = ",", fill = FALSE)
