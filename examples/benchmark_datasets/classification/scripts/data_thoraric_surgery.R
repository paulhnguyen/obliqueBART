...
# Details: thoraric surgery dataset (https://archive.ics.uci.edu/dataset/277/thoracic+surgery+data)
# Dependencies: 
set.seed(2)
data_dir = "../source/ThoraricSurgery.arff"
save_dir = "../data/"
name = "thoraric_surgery"
...
Y = as.integer(ifelse(data[,17] == "T", 1, 0))
X_cont = data[,c(2,3,16)]
