...
# Details: mammographic mass dataset (https://archive.ics.uci.edu/dataset/52/ionosphere)
# Dependencies: 
set.seed(2)
data_dir = "../source/mammographic_masses.data"
save_dir = "../data/"
...
Y = as.integer(ifelse(data[6] == 1, 1, 0))
X_cont = data[,c(2)]
