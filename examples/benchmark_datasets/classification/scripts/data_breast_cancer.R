...
# Details: breast cancer original dataset (https://archive.ics.uci.edu/dataset/15/breast+cancer+wisconsin+original)
# Dependencies: 
set.seed(2)
data_dir = "../source/breast-cancer-wisconsin.data"
save_dir = "../data/"
...
Y = as.integer(ifelse(data[,11] == 4, 1, 0))
X_cont = data[, c(2:10)] 
