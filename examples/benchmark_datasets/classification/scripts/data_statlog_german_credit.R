...
# Details: statlog german credit dataset (https://archive.ics.uci.edu/dataset/144/statlog+german+credit+data)
# Dependencies: 
set.seed(2)
data_dir = "../source/german.data"
save_dir = "../data/"
...
X_cont = data[,c(2, 5, 8, 11, 13,16,18)]
X_cont <- sapply( X_cont, as.numeric )
X_cat = data[c(1,3,4,6,7,9,10,12,14,15,17,19,20)]
