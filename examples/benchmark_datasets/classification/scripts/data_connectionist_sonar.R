...
# Details: connectionist sonar (https://archive.ics.uci.edu/dataset/151/connectionist+bench+sonar+mines+vs+rocks)
# Dependencies: 
set.seed(2)
data_dir = "../source/sonar.all-data"
save_dir = "../data/"
...
Y = as.integer(ifelse(data[,61] == "R", 1, 0))
X_cont = data[,1:60]
