...
# Details: acute inflammation 1 dataset (https://archive.ics.uci.edu/dataset/184/acute+inflammations)
# Dependencies: 
set.seed(2)
data_dir = "../source/inflammations_diagnosis.data"
save_dir = "../data/"
name = "acute_inflammations_1"
...
Y = as.integer(ifelse(data[,7] == "yes", 1, 0))
X_cont = data[, c(1)] 
