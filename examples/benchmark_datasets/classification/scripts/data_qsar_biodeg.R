...
# Details: qsar biodegradation dataset (https://archive.ics.uci.edu/dataset/254/qsar+biodegradation)
# Dependencies: 
set.seed(2)
data_dir = "../source/biodeg.csv"
save_dir = "../data/"
name = "qsar_biodegradable"

# setup -------------------------------------------------------------------
data = read.table(data_dir, sep = ";", header = FALSE)
...
Y = as.integer(ifelse(data[,42] == "RB", 1, 0))
X_cont = data[,c(1:23, 26:28,30:41)]
X_cont <- sapply( X_cont, as.numeric )
X_cat = data[,c(24,25,29)]
