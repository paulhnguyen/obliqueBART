...
# Details: ozone detection level 1 dataset (https://archive.ics.uci.edu/dataset/172/ozone+level+detection)
# Dependencies: 
set.seed(2)
data_dir = "../source/onehr.data"
save_dir = "../data/"
name = "ozone_detection_level_1"
...
Y = as.integer(ifelse(data[,74] == 1, 1, 0))
X_cont = data[,c(2:73)]
