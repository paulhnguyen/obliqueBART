...
# Details: parkinsons dataset (https://archive.ics.uci.edu/dataset/174/parkinsons)
# Dependencies: 
...
# load data
data = read.csv(paste0(data_dir, "parkinsons.data"), header = TRUE, sep = ",", fill = FALSE)
