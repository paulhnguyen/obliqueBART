...
# Details: cylinder bands dataset (https://archive.ics.uci.edu/dataset/32/cylinder+bands)
# Dependencies: 
set.seed(2)
data_dir = "../source/bands.data"
save_dir = "../data/"
name = "cylinder_bands"

# setup -------------------------------------------------------------------
data = read.table("bands.data", sep=",")
#removed line 522, but will be removed anyway
...
Y = as.integer(ifelse(data[,40] == "band", 1, 0))
X_cont = data[,c(21:39)]
