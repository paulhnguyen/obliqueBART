...
# Details: fertility dataset (https://archive.ics.uci.edu/dataset/244/fertility)
# Dependencies: 
...
# load data
data = read.table(paste0(data_dir, "fertility_diagnosis.txt"), header = FALSE, sep = ",")
...
Y = as.integer(ifelse(data[,10] == "N", 0, 1))
