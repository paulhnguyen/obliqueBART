...
# Details: blood transfusion dataset (https://archive.ics.uci.edu/dataset/176/blood+transfusion+service+center)
# Dependencies: 
set.seed(2)
data_dir = "../source/transfusion.data"
save_dir = "../data/"
name = "blood_transfusion"

# setup -------------------------------------------------------------------
data = read.table("transfusion.data", sep=",", header = T)
