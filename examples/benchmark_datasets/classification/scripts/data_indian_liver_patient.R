...
# Details: indian liver patient dataset (https://archive.ics.uci.edu/dataset/225/ilpd+indian+liver+patient+dataset)
# Dependencies: 
set.seed(2)
data_dir = "../source/ILPD_data.csv"
save_dir = "../data/"
name = "ILPD"
...
Y = as.integer(ifelse(data[,11] == "1", 1, 0))
X_cont = data[,c(1,3:10)]
