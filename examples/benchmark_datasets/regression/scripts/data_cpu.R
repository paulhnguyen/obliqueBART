...
# Details: Computer Hardware (cpu) dataset (https://archive.ics.uci.edu/dataset/29/computer+hardware)
# Dependencies: 
...
# load data
data = read.csv(paste0(data_dir, "machine.data"), sep = ",", header = FALSE)
