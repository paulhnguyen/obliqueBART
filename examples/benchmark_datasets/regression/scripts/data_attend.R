...
# Details: MLB attendance dataset (https://jse.amstat.org/datasets/MLBattend.txt)
# Dependencies: 

data_dir = "../source/MLBattend.dat.txt"
save_dir = "../data/"
name = "attend"
...
# load data
data = read.table(data_dir, header = FALSE, fill = TRUE)
# remove rows with missing data
data = na.omit(data)

# split data into continuous and categorical data types
Y = data[,5]
X_cont = data[, c(4,6:10)]
X_cat = data[, c(1:3)]
