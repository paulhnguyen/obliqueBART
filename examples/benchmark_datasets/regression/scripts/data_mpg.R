...
# Details: Auto MPG (mpg) dataset (https://archive.ics.uci.edu/dataset/9/auto+mpg)
# Dependencies: 
...
# load data
data = read.table(paste0(data_dir, "auto-mpg.data"), header = FALSE, fill = TRUE)

# column 4 is read in as character due to some NA entries
