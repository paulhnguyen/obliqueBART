...
# Details: Amenity dataset (http://qed.econ.queensu.ca/jae/datasets/chattopadhyay001/)
# Dependencies: 

# setup -------------------------------------------------------------------
set.seed(2)
data_dir = "../source/amenity_data/"
save_dir = "../data/"
name = "amenity"
...
table1 = read.table(paste0(data_dir, "headdata1.dat"), header = FALSE)
table2 = read.table(paste0(data_dir, "headdata2.dat"), header = FALSE)
data = dplyr::bind_cols(table1, table2)
colnames(data) = paste0("V", seq(1, 26))
...
Y = data[,1]
X_cont = data[, c(2:7, 9, 11:20, 22:23, 26)]
X_cat = data[, c(8, 10, 21, 24, 25)]
