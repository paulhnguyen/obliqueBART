...
# Details: basketball dataset (https://pages.stern.nyu.edu/~jsimonof/SmoothMeth/Data/ASCII/)
# Dependencies: 

data_dir = "../source/baskball.txt"
save_dir = "../data/"
name = "basketball"

# setup -------------------------------------------------------------------
data = read.delim2(paste0(data_dir), sep = "\t",header = T)
