...
# Details: baseball performance/salary dataset (https://search.r-project.org/CRAN/refmans/ISLR/html/Hitters.html)
# Dependencies: ISLR
save_dir = "../data/"
name = "baseball"
...
# data available from ISLR package
library(ISLR)
data("Hitters")
...
Y = data[, 19]
X_cont = data[, c(1:13, 16:18)]
X_cat = data[, c(14:15, 20)]
