...
# Details: Rice dataset (http://qed.econ.queensu.ca/jae/datasets/horrace001/)
# Dependencies: 
...
# load data
data = read.table(paste0(data_dir, "ricefarm.dat"), header = TRUE, fill = TRUE)
