---
title: "Classification Example: Banknote"
date: "`r Sys.Date()`"
...
Below, we load the [*banknote authentication*](https://archive.ics.uci.edu/dataset/267/banknote+authentication) dataset. 
...
We have loaded the data, scaled the predictors, and created 20 sets of training and testing partitions. Let us continue with the first partition. Note that we use the function *probit_obliqueBART_lp* for classification, rathter than *obliqueBART_lp*, and that $Y$ is converted to the integer class.
