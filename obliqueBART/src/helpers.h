...
public:
  ...
  double prob_single_index_split;
  //int oblique_option;
  bool dense_phi;
  int phi_option;
  int x0_option;
  ...
  std::pair<int, int>* entry_count; // counts the number of non-zero entries for phi. the first of the pair will represent the non-zero entries, nad end second of the pair represents the number of zero-entries in phi (over the entire tree)
